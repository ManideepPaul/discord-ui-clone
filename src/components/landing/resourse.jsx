  ...
  return (
    <div className="resourseContainer">
      <div className="heading">
        <span className="resourseHeading">IMAGINE A</span>
        <p className="resourseHeading">PLACE</p>
        <div className="country">
          <img src={props.usa} alt="USA" />
          <span className="countryName">English, USA</span>
        </div>
